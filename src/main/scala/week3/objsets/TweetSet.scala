...
object Empty extends TweetSet {
   ...
   * and be implemented in the subclasses?
   */
  override def mostRetweeted: Tweet = throw new Error("Empty.mostRweeted")
   ...
   * and be implemented in the subclasses?
   */
  override def descendingByRetweet: TweetList = throw new Error("Empty.descendingByRetweet")
